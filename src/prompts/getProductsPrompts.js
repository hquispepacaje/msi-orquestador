...
const getProductsToolDescriptionPrompt = `Util cuando el usuario muestra interes en conocer los productos de la tienda.
Tambien es util cuando el cliente pide recomendaciones sobre productos.
El cliente puede pedir productos en general o productos de una categoría específica.
`;
...
module.exports = { getProductsPrompt, getProductsToolDescriptionPrompt, getCategoryNamePrompt };
